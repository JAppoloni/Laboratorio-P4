...
class IControladorHostal{
    public:
        ...
        virtual list<DTHostal *> obtenerHostales() = 0;//alta habitacion; asignar empleado a hostal; realizar reserva(imprimri también prom. calif.); registrar estadia; finalizar estadia; calificar estadia; baja reserva
