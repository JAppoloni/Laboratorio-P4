...
public:
    ...
    virtual set<DTHabitacion *> listarHabitacionesDisponibles(string nombHost, DTFecha in, DTFecha fin) = 0; // realizar reserva
    ...
    virtual void confirmarAccion() = 0;                                                                      // baja reserva
